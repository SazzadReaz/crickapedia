                 ...
                 <div class="col py-3 content-area">
                     <div class="container text-start">
                        ...
                        @endif
                            ...
                            <form action="{{ route('stadium.destroy', $data->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this stadium Details?');">
                                    Delete
                                </button>
                            </form>
